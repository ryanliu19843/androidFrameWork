...
public class Simple extends BaseItem{
    ...
    public void set(final int posion,final CardSimple card){
        this.card=card;
        SimpleSet item=card.item;
        icon1.setTocolor(item.icon1toc);
        icon2.setTocolor(item.icon2toc);
...
//                Log.d("sss", mBitmap.toString());
        ...
        relalayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PhotoShow ps=new PhotoShow(context,card.item.bacground);
                ps.show();
            }
        });
...
//        relalayout.setBlur(10);
    ...
    public static class SimpleSet {
        ...
        public SimpleSet(String bacground, String icon, String name, String value, String v2,int i1ct,int i2ct) {
