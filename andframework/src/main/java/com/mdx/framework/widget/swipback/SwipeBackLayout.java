package com.mdx.framework.widget.swipback;
...
public class SwipeBackLayout extends FrameLayout {
	...
	public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		int shadowLeft = a.getResourceId(R.styleable.SwipeBackLayout_shadow_left, R.drawable.swipactivity_shadow_left);
		int shadowRight = a.getResourceId(R.styleable.SwipeBackLayout_shadow_right, R.drawable.shadow_right);
		int shadowBottom = a.getResourceId(R.styleable.SwipeBackLayout_shadow_bottom, R.drawable.swipactivity_shadow_bottom);
	 ...
	 * @param sensitivity
	 *            value between 0 and 1, the final value for touchSlop = ViewConfiguration.getScaledTouchSlop * (1 / s);
	 */
