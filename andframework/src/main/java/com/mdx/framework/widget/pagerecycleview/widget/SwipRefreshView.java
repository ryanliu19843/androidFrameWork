...
import com.mdx.framework.widget.pagerecycleview.pullanimview.SwipRefresh;
...
public class SwipRefreshView extends RelativeLayout {
    ...
    private float om = 0, smv = 0,nmv=0,nmt=0;
    ...
    public void setSwipRefresh(SwipRefresh swipRefresh) {
        ...
        this.animator=null;
        this.animatorpull=null;
        this.animatorend=null;
        if(mRecyclerView!=null) {
            this.swipRefresh.setState(state);
            if (mRecyclerView.getOrientation() == LinearLayoutManager.VERTICAL) {
                setH(nmv, nmt);
            } else {
                setW(nmv, nmt);
    ...
    public void pullReload() {
        ...
        if (animatorpull == null) {
            if (swipRefresh != null) {
                ...
                animatorpull = this.getPullAnimator();
            }
    ...
    public void setloadend(float mv) {
        ...
        if (animatorend == null) {
            if (swipRefresh != null) {
                ...
                animatorend = this.getEndAnimator();
            }
