...
public class SmoothProgressDrawable extends Drawable implements Animatable {
  ...
  public static class Builder {
    ...
    private void initValues(Context context) {
      ...
      mSectionsCount = 4;
      mColors = new int[]{0xff0099cc,0xffff8800,0xff669900,0xff9933cc,0xffcc0000};
      mSpeed = 1.0f;
      mProgressiveStartSpeed = mSpeed;
      mProgressiveStopSpeed = mSpeed;
      mReversed = false;
      mStrokeSeparatorLength =(int) (4*Device.getDensity());
      mStrokeWidth =(int) (1*Device.getDensity());;
