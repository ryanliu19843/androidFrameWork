/*
 * 文件名: AreaChoose.java 版 权： Copyright Huawei Tech. Co. Ltd. All Rights
 * Reserved. 描 述: [该类的简要描述] 创建人: Administrator 创建时间:2014-12-21
 * 
 * 修改人： 修改时间: 修改内容：[修改内容]
 */
 ...
 * @version [2014-12-21 下午9:26:47]
 */
public class AddressChoose implements DataChoose{
    
    private int[] city = { R.array.buxian_province_item, R.array.beijin_province_item, R.array.tianjin_province_item,
            ...
            R.array.shanghai_province_item, R.array.jiangsu_province_item, R.array.zhejiang_province_item,
            R.array.anhui_province_item, R.array.fujian_province_item, R.array.jiangxi_province_item,
            R.array.shandong_province_item, R.array.henan_province_item, R.array.hubei_province_item,
            R.array.hunan_province_item, R.array.guangdong_province_item, R.array.guangxi_province_item,
            R.array.hainan_province_item,  R.array.sichuan_province_item,
            R.array.guizhou_province_item, R.array.yunnan_province_item, R.array.xizang_province_item,
            R.array.shanxi2_province_item, R.array.gansu_province_item, R.array.qinghai_province_item,
            R.array.linxia_province_item, R.array.xinjiang_province_item, R.array.hongkong_province_item,
            R.array.aomen_province_item, R.array.taiwan_province_item };
    
    // 第三级资源
    private int[] countyOfBuXian = { R.array.buxian_city_item };
    ...
    public int gettheed(int first,Object fitem, int second,Object sitem) {
        switch (first) {
            case 0:
                return countyOfBuXian[second];
                
            case 1:
                return countyOfBeiJing[second];
                
            case 2:
                return countyOfTianJing[second];
                
            case 3:
                return countyOfHeBei[second];
                
            case 4:
                return countyOfShanXi1[second];
                
            case 5:
                return countyOfNeiMengGu[second];
                
            case 6:
                return countyOfLiaoNing[second];
                
            case 7:
                return countyOfJiLin[second];
                
            case 8:
                return countyOfHeiLongJiang[second];
                
            case 9:
                return countyOfShangHai[second];
                
            case 10:
                return countyOfJiangSu[second];
                
            case 11:
                return countyOfZheJiang[second];
                
            case 12:
                return countyOfAnHui[second];
                
            case 13:
                return countyOfFuJian[second];
                
            case 14:
                return countyOfJiangXi[second];
                
            case 15:
                return countyOfShanDong[second];
                
            case 16:
                return countyOfHeNan[second];
                
            case 17:
                return countyOfHuBei[second];
                
            case 18:
                return countyOfHuNan[second];
                
            case 19:
                return countyOfGuangDong[second];
                
            case 20:
                return countyOfGuangXi[second];
                
            case 21:
                return countyOfHaiNan[second];
                
            case 22:
                return countyOfSiChuan[second];
                
            case 23:
                return countyOfGuiZhou[second];
                
            case 24:
                return countyOfYunNan[second];
                
            case 25:
                return countyOfXiZang[second];
                
            case 26:
                return countyOfShanXi2[second];
                
            case 27:
                return countyOfGanSu[second];
                
            case 28:
                return countyOfQingHai[second];
                
            case 29:
                return countyOfNingXia[second];
                
            case 30:
                return countyOfXinJiang[second];
                
            case 31:// 此三个地区没有写详细分类
                return countyOfHongKong[second];
                
            case 32:
                return countyOfAoMen[second];
                
            case 33:
                return countyOfTaiWan[second];
