...
public class FitFrameLayout extends FrameLayout implements FitLayout {
    ...
    public FitFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        getAttr(context, attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public FitFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
