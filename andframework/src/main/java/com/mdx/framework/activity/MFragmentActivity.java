...
public abstract class MFragmentActivity extends FragmentActivity implements Prompt, IActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Frame.onResumeListener != null) {
            Frame.onResumeListener.onCreate(this, getId());
        }
    ...
    protected void onResume() {
        ...
        if (Frame.onResumeListener != null) {
            Frame.onResumeListener.onResume(this, getId());
        }
        resume();
    }
