...
public class GifDecoder {
     ...
     */
    public void seekToTime(@IntRange(from = 0, to = Integer.MAX_VALUE) final int position, @NonNull final Bitmap buffer, int blur) {
        checkBuffer(buffer);
        mGifInfoHandle.seekToTime(position, buffer, blur);
    }
